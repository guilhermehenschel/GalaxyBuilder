...
Dialog {
            ...
            GridLayout {
                ...
                ComboBox {
                    ...
                    onCurrentIndexChanged: {
                        if (planetViewModel)
                            planetViewModel.planetType = currentIndex;
                    }
                }
                ...
                SpinBox {
                    ...
                    onValueChanged: {
                        if (planetViewModel)
                            planetViewModel.size = realValue;
                    }
                }
                ...
                SpinBox {
                    ...
                    onValueChanged: {
                        if (planetViewModel)
                            planetViewModel.mass = realValue;
                    }
                }
                ...
                SpinBox {
                    ...
                    onValueChanged: {
                        if (planetViewModel)
                            planetViewModel.numberOfMoons = value;
                    }
                }
                ...
                SpinBox {
                    ...
                    onValueChanged: {
                        if (planetViewModel)
                            planetViewModel.orbitalRadius = realValue;
                    }
                }
                ...
                SpinBox {
                    ...
                    onValueChanged: {
                        if (planetViewModel)
                            planetViewModel.maxTemperature = realValue;
                    }
                }
                ...
                SpinBox {
                    ...
                    onValueChanged: {
                        if (planetViewModel)
                            planetViewModel.minTemperature = realValue;
                    }
                }
            }
    ...
    footer: RowLayout {
        ...
        Button {
            ...
            onClicked: {
                if (editMode) {
                    planetEdited(originalPlanetName, nameField.text || "Planet", typeCombo.currentIndex, sizeSpinBox.realValue, massSpinBox.realValue, moonsSpinBox.value, radiusSpinBox.realValue, maxTempSpinBox.realValue, minTempSpinBox.realValue);
                } else if (isNewPlanet) {
                    planetCreated(nameField.text || "New Planet", typeCombo.currentIndex, sizeSpinBox.realValue, massSpinBox.realValue, moonsSpinBox.value, radiusSpinBox.realValue, maxTempSpinBox.realValue, minTempSpinBox.realValue);
                } else {
                    planetUpdated();
                }
                root.close();
    ...
    function getPlanetColor(type) {
        switch (type) {
        case 0:
            return "#8B4513";  // Rocky - Brown
        case 1:
            return "#FFA500";  // Gas Giant - Orange
        case 2:
            return "#4169E1";  // Ice Giant - Blue
        case 3:
            return "#DAA520";  // Desert - Golden
        case 4:
            return "#0000FF";  // Ocean - Blue
        case 5:
            return "#E0E0E0";  // Frozen - Light Gray
        case 6:
            return "#FF4500";  // Volcanic - Red-Orange
        case 7:
            return "#9932CC";  // Toxic - Purple
        default:
            return "#888888";
        }
    }
