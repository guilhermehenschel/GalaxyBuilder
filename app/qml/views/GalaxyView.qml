    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onWheel: function (wheel) {
                ...
                var offset = Qt.point(mousePos.x - centerPos.x - panOffset.x, mousePos.y - centerPos.y - panOffset.y);

                panOffset = Qt.point(panOffset.x + offset.x * (1 - newZoom / zoomFactor), panOffset.y + offset.y * (1 - newZoom / zoomFactor));
