...
void TestXmlValidator::testValidXmlFile()
{
...
<Galaxy>
    ...
    QCOMPARE(result.detectedType, XmlValidator::XmlType::Galaxy);
}

void TestXmlValidator::testInvalidXmlFile()
{
...
{
    QTemporaryFile* tempFile = new QTemporaryFile(m_tempDir->filePath("test_XXXXXX" + suffix), this);
...
#include "test_xmlvalidator.moc"
QTEST_MAIN(TestXmlValidator)
